...
const Register = () => {
  ...
  const validate = () => {
    ...
    if (!formData.fullname.trim()) {
      ...
      newErrors.fullname = "Họ tên không được it hơn 2 kí tự";
    }
    ...
    if (!formData.password.trim()) {
      ...
      newErrors.password = "password không được it hơn 6 kí tự";
    }

    if (!formData.confirmPassword.trim()) {
      newErrors.confirmPassword = "vui lòng xác nhận mật khẩu";
    } else if (formData.confirmPassword !== formData.password) {
      newErrors.confirmPassword = "mật khâu xác nhận không khớp";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        setErrors({ submit: "eamil đã tồn tại" });
      } 
    }
  };
    ...
    <div className="min-h-screen w-full relative bg-white flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md z-10 px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Đăng ký để bắt đầu sử dụng ứng dụng</p>
        </div>
